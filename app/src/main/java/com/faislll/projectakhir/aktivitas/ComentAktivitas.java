...
public class ComentAktivitas extends AppCompatActivity {
    private static final String TAG = "ComentAktivitas";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.coment_aktivitas);
        init();
        ...
        textViewKirimComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (editTextComment.getText().toString().matches("")) {
                    Toast.makeText(ComentAktivitas.this, "anda tidak bisa mengirimkan komentar kosong", Toast.LENGTH_SHORT).show();
                } else {
                    tambahDataKomentar();
                }
            }
    ...
    public void tambahDataKomentar() {
        ...
        FirebaseFirestore.getInstance().collection("comments").document(postid).collection(postid)
            ...
            public void onComplete(@NonNull Task<DocumentReference> task) {
                Toast.makeText(ComentAktivitas.this, "komen berhasil dikirim", Toast.LENGTH_SHORT).show();
                addNotifikasi();
    ...
    private void init() {
        ...
        textViewKirimComment = findViewById(R.id.e_text_kirim_kcomment);
